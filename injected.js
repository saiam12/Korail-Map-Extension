...
waitForL(() => {
  ...
  const TEXT = {
    ko: {
      ...
      distanceHint: "가까운 후보를 고른 뒤 선택한 이동시간으로 순위를 정합니다.",
      ...
      drivingUnavailable: "자동차 시간을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.",
      transitUnavailable: "대중교통 경로를 찾지 못했거나 시간을 불러오지 못했습니다.",
    ...
    en: {
      ...
      distanceHint: "Nearby candidates are ranked by the selected travel time.",
      ...
      drivingUnavailable: "Unable to load driving times. Please try again shortly.",
      transitUnavailable: "No public transit route was found, or its travel time could not be loaded.",
